...
prototxtPath=os.path.sep.join([r'C:\\Users\\Noel Kurien\\Downloads','deploy.prototxt'])
weightsPath=os.path.sep.join([r'C:\\Users\\Noel Kurien\\Downloads','res10_300x300_ssd_iter_140000.caffemodel'])
